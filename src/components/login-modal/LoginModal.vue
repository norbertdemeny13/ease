          ...
          <form>
            <div v-if="isSignIn" class="sign-in-wrapper">
              <div class="form-group">
                ...
                <input type="email" class="form-control" name="email" id="email" v-model="form.email" placeholder="auth.emailPlaceholder">
              </div>
              <div class="form-group">
            ...
            <div v-else class="sign-up-wrapper">
              <div>
                <div class="form-group">
                  <label>{{ $t('generic.email') }}</label>
                  <input type="email" required class="form-control" name="email" id="email" v-model="form.email" placeholder="auth.emailPlaceholder">
                </div>
                <div class="form-group">
                  <label>{{ $t('generic.first_name') }}</label>
                  <input type="email" class="form-control" name="firstName" id="firstName" v-model="form.first_name" placeholder="auth.firstNamePlaceholder">
                </div>
                <div class="form-group">
                  <label>{{ $t('generic.last_name') }}</label>
                  <input type="email" class="form-control" name="lastName" id="lastName" v-model="form.last_name" placeholder="auth.lastNamePlaceholder">
                </div>
                <div class="form-group">
                  <label>{{ $t('generic.password') }}</label>
                  <input
              ...
              <div id="forgot_pw">
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" name="email_forgot" id="email_forgot" placeholder="auth.emailPlaceholder">
                  <i class="icon_mail_alt" />
                </div>
                <p>{{ $t('reset_password_email_sent') }}</p>
                <div class="text-center"><input type="submit" value="Reset Password" class="btn_1" placeholder="auth.passwordPlaceholder"></div>
              </div>
            </div>
          </form>
          <!--form -->
